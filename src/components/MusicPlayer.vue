...
onMounted(() => {
    ...
    if (currentTrack.value) {
        ...
        seekerContainer.value.addEventListener('click', function (e) {
            const clickPosition = (e.pageX - seekerContainer.value.offsetLeft) / (e.pageX - seekerContainer.value.offsetWidth)
        ...
        <div class="flex items-center w-1/4">
            <div class="flex items-center ml-4">
                ...
                <div class="ml-4">
                    ...
                    <div class="text-[14px] text-gray-500 hover:underline hover:text-white cursor-pointer">
                        {{ currentArtist.name }}
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-[35%] mx-auto w-2/4 mb-3">
            <div class="flex-col items-center justify-center">
                ...
                <div class="flex items-center h-[25px]">
                    <div v-if="isTrackTimeTotal" class="text-white text-white text-[12px] pr-2 pt-[11px]">{{ isTrackTimeCurrent }}</div>
                    <div
                        ref="seekerContainer"
