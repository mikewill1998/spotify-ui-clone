      ...
      <button 
        ...
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27" 
            src="https://yt3.ggpht.com/ytc/AGIKgqNa3hZScYyxaNWOV_0NKBpl1mXj0HxwBZqkgozdtwFKUrncYH5TE9mzJJRL59xNkn-9Gik=s88-c-k-c0x00ffffff-no-rj-mo"
          >
          <div class="text-white text-[14px] ml-1.5 font-semibold">Mike</div>
